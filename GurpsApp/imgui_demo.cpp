...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("GURPSapp Testing Framework", p_open, window_flags))
    {
	...
	//TESTING VARIOUS FUNCTIONS WITH THIS THING

	//THESE CONTENTS SHOULD BE NESTED EVENTUALLY WITHIN GURPTEST.CPP for Maximum Portability.
	//if (ImGui::CollapsingHeader("Intruding Header THing"))
	//{
	//	if (ImGui::TreeNode("NEST UP"))
	//	{
	//		ImGui::ShowStyleEditor();
	//		ImGui::TreePop();
	//	}
	//	ImGui::Checkbox("Beep Boop Check me!", &no_titlebar); ImGui::SameLine(150);
	//	ImGui::Checkbox("Ha Go and Check me too!", &no_titlebar);
	//	
	//}
	...
	*/
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
		...
		*/
		...
		//STUFF ABOUT BUTTONS AND RETURNED STUFF OVER HERE!
		// GIVE IT A LOOK!
	...
	*/
    ...
    {
		int newDMG = 0;
		ImGui::DragInt("Slide Me!", &newDMG, 0, 0, 100);
		Popups();
